...
import com.wf.ew.common.exception.CustomException;
...
public class SerialPortUtils implements SerialPortEventListener {
	...
	public static StringBuilder ssb = new StringBuilder() ;
    // 检测系统中可用的通讯端口类
    ...
    public void readComm() {
        try {
            ...
            // 直接获取到的数据
                data = new String(readBuffer, 0, len,"utf-8").trim();
            // 转为十六进制数据
    ...
    public static void main(String[] args) {
		System.out.println(bytesToHexString("@0600".getBytes()));
	}
}